...
\footnotetext{I opted for sqlite instead of mySQL since sqlite does not require installing any specialy software or running an SQL server locally and is shipped with Python as a standard package.}
