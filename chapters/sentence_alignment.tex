...
Such duplicate sentences are not simply redundant in the corpus, but are might also be considered noise in the data. % which might negatively influence an \acrshort{nmt} model trained on this corpus \autocite{thompson-koehn-2019-vecalign}. 
