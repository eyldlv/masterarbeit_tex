...
German uses many verbs to which an adverb or a preposition is affixed in order to delimit the verb's meaning or sometimes completely it (dubbed \enquote{separable verbs}). 
Since both the verb and the adverb form together the meaning of the word and are conceptually inseparable, both of them should be aligned to the corresponding Romansh verb, resulting in a 2-to-1 alignment.
